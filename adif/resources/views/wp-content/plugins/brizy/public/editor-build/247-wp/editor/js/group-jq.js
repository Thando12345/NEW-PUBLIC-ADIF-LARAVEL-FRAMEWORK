window.BrizyLibs = function(e) {
    ...
    var t = n(0),
        o = n.n(t);
    if (window.jQuery) {
        ["scrollPane", "backgroundVideo", "parallax", "brzSticky"].forEach((e => {
            window.jQuery.fn[e] || (window.jQuery.fn[e] = o.a.fn[e])
        }))
    } else window.jQuery = o.a
}]);